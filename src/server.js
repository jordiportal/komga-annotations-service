...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`[annotations] LiteLLM: ${process.env.LITELLM_URL || 'https://litellm.khlloreda.com'} | Modelo: ${process.env.LLM_MODEL || 'deepseek-v4-flash'} | PREFETCH_COUNT: ${process.env.PREFETCH_COUNT || 3}`)
})
